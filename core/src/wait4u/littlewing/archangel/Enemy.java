...
public class Enemy
{
    public int enemy_distance_1 = this.enemy_distance_2 = this.c = this.d = this.e = this.f = this.g = this.h = this.i = this.j = this.k = this.l = this.enemy_damage = 0;
    ...
    public int enemy_damage; // m: enemy damage
