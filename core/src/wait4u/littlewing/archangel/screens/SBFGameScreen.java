...
import wait4u.littlewing.archangel.Boss;
import wait4u.littlewing.archangel.Hero;
...
public class SBFGameScreen extends DefaultScreen implements InputProcessor {
    ...
    public SBFGameScreen(Game game, int param_screen, int param_school) {
        super(game);
